...
- Changed Modules / Files: `migrations/vone/versioned`; `migrations/vone/sqlite`; `internal/database/migration.go`; migration rehearsal tests
- Why this level is enough now: 独立 VONE ledger、Owner 回填、未分类集合与可逆迁移已完成；未改写上游迁移和 `kb_shares`。

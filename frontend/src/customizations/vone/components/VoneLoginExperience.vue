<template>
  <main class="vone-auth-shell">
    <section class="vone-auth-story" aria-label="VONE Knowledge">
...
const copy = computed(() => isChinese.value ? {
  ...
  registerSubtitle: '创建账户并开始使用 VONE知识库',
  noAccount: '还没有账户？',
  themeLabel: '界面主题',
} : {
  ...
  registerSubtitle: 'Create an account and start using Vone Knowledge.',
  noAccount: 'New to Vone Knowledge?',

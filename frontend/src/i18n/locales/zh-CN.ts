export default {
  ...
  knowledgeEditor: {
    ...
    activity: {
      ...
      actions: {
        ...
        'kb.member_granted': '授予知识库成员权限',
        'kb.member_changed': '变更知识库成员权限',
        'kb.member_revoked': '撤销知识库成员权限',
        'kb.collection_created': '创建项目节点',
        'kb.collection_updated': '更新项目节点',
        'kb.collection_deleted': '删除项目节点',
        'kb.collection_bound': '调整知识库项目归类',
        'rbac.access_denied': '拒绝知识库访问',
  ...
  kbAcl: {
    permissionRevoked: '当前账号没有查看该内容的权限，权限可能已被撤销。',
    aiOnly: { title: '该知识库仅授权 AI 搜索', description: '你可以查看回答中的文件名称、引用来源和原文片段，但不能浏览文件列表、全文或原始切片。', action: '开始 AI 搜索' },
    members: { title: '成员与权限', description: '为工作空间员工分配该知识库的使用、预览、编辑和删除权限。', selectEmployee: '选择员工', customPermissions: '自定义权限', removeConfirm: '确定移除该成员？', removeOwnerConfirm: '确定移除这位共同所有者？系统不会允许移除最后一位所有者。', addOwnerConfirm: '确定将该员工设为共同所有者？共同所有者拥有知识库的全部权限。', changeOwnerConfirm: '此次操作会新增或撤销共同所有者权限，确定继续？', ownerPermissionRequired: '只有具备“管理共同所有者”权限的成员才能执行此操作。', added: '成员已添加', addFailed: '添加成员失败', updated: '权限已更新', updateFailed: '更新权限失败', removed: '成员已移除', removeFailed: '移除成员失败', empty: '暂无成员' },
    roles: { owner: '共同所有者', editor: '编辑者', documentViewer: '文档查看者', aiUser: '仅 AI 使用', custom: '自定义权限' },
    capabilities: { aiQuery: 'AI 搜索', metadataRead: '查看知识库信息', documentsList: '查看文件列表', documentPreview: '预览全文', chunkPreview: '预览切片', documentDownload: '下载文件', documentUpload: '上传文件', documentEdit: '编辑文件', documentDelete: '删除文件', documentReparse: '重新解析', chunkEdit: '编辑切片', chunkDelete: '删除切片', folderManage: '管理目录', settingsEdit: '编辑设置', kbDelete: '删除知识库', membersManage: '管理成员', ownersManage: '管理共同所有者' },
    collections: { title: '项目结构', description: '按项目或产品组织知识库', all: '全部知识库', unclassified: '未分类', empty: '暂无项目或知识库', emptyFiltered: '当前项目节点下暂无知识库', createRoot: '新建项目', createChild: '新建子项目', rename: '重命名', move: '移动', moveUp: '上移', moveDown: '下移', delete: '删除', bindPlaceholder: '选择要归入当前节点的知识库', bind: '确认归类', namePrompt: '请输入项目名称', childNamePrompt: '请输入子项目名称', renamePrompt: '请输入新的项目名称', movePrompt: '输入新的父项目 ID；留空移动到根节点：', deleteConfirm: '仅空项目可以删除，确定继续？', created: '项目已创建', createFailed: '项目创建失败', renamed: '项目已重命名', renameFailed: '项目重命名失败', moved: '项目已移动', moveFailed: '项目移动失败', deleted: '项目已删除', deleteFailed: '项目删除失败', bound: '知识库归类已更新', bindFailed: '知识库归类失败', loadFailed: '项目结构加载失败' }
  },
  knowledgeBase: {
    title: '知识库',
    fileContent: '文件内容',
    ...
    confirmDeleteChunk: '确定删除该切片？此操作不会删除原文件或整个知识库。',
    chunkDeleted: '切片已删除',
    chunkDeleteFailed: '切片删除失败',

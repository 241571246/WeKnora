export default {
  ...
  createChat: {
    title: 'Здравствуйте, я — корпоративный ИИ-мозг. Пусть знания направляют каждое решение',
  ...
  kbAcl: {
    permissionRevoked: 'You cannot view this content. Your permission may have been revoked.',
    aiOnly: { title: 'AI search only', description: 'Answers may show file names, sources and relevant excerpts, but you cannot browse files, full text or raw chunks.', action: 'Start AI search' },
    members: { title: 'Members and permissions', description: 'Assign separate use, preview, edit and delete capabilities.', selectEmployee: 'Select employee', customPermissions: 'Custom permissions', removeConfirm: 'Remove this member?', removeOwnerConfirm: 'Remove this co-owner? The final owner cannot be removed.', addOwnerConfirm: 'Make this employee a co-owner with full knowledge-base permissions?', changeOwnerConfirm: 'This changes co-owner status. Continue?', ownerPermissionRequired: 'The Manage co-owners capability is required.', added: 'Member added', addFailed: 'Could not add member', updated: 'Permissions updated', updateFailed: 'Could not update permissions', removed: 'Member removed', removeFailed: 'Could not remove member', empty: 'No members' },
    roles: { owner: 'Co-owner', editor: 'Editor', documentViewer: 'Document viewer', aiUser: 'AI only', custom: 'Custom' },
    capabilities: { aiQuery: 'AI search', metadataRead: 'View knowledge base details', documentsList: 'View file list', documentPreview: 'Preview full text', chunkPreview: 'Preview chunks', documentDownload: 'Download files', documentUpload: 'Upload files', documentEdit: 'Edit files', documentDelete: 'Delete files', documentReparse: 'Reparse files', chunkEdit: 'Edit chunks', chunkDelete: 'Delete chunks', folderManage: 'Manage folders', settingsEdit: 'Edit settings', kbDelete: 'Delete knowledge base', membersManage: 'Manage members', ownersManage: 'Manage co-owners' },
    collections: { title: 'Project structure', description: 'Organize knowledge bases by project or product', all: 'All knowledge bases', unclassified: 'Unclassified', empty: 'No projects or knowledge bases', emptyFiltered: 'No knowledge bases in this project node', createRoot: 'New project', createChild: 'New subproject', rename: 'Rename', move: 'Move', moveUp: 'Move up', moveDown: 'Move down', delete: 'Delete', bindPlaceholder: 'Select a knowledge base', bind: 'Confirm placement', namePrompt: 'Project name', childNamePrompt: 'Subproject name', renamePrompt: 'New project name', movePrompt: 'Enter the new parent project ID; leave empty for root:', deleteConfirm: 'Only empty projects can be deleted. Continue?', created: 'Project created', createFailed: 'Could not create project', renamed: 'Project renamed', renameFailed: 'Could not rename project', moved: 'Project moved', moveFailed: 'Could not move project', deleted: 'Project deleted', deleteFailed: 'Could not delete project', bound: 'Knowledge-base placement updated', bindFailed: 'Could not update placement', loadFailed: 'Could not load project structure' }
  },
  knowledgeBase: {
    title: 'База знаний',
    ...
    confirmDeleteChunk: 'Delete this chunk? The source document and knowledge base will remain.',
    chunkDeleted: 'Chunk deleted',
    chunkDeleteFailed: 'Could not delete chunk',

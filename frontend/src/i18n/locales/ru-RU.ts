export default {
  ...
  kbAcl: {
    ...
    collections: { title: 'Project structure', description: 'Organize knowledge bases by project or product', all: 'All knowledge bases', unclassified: 'Unclassified', empty: 'No projects or knowledge bases', createRoot: 'New project', createChild: 'New subproject', rename: 'Rename', move: 'Move', moveUp: 'Move up', moveDown: 'Move down', delete: 'Delete', bindPlaceholder: 'Select a knowledge base', bind: 'Confirm placement', namePrompt: 'Project name', childNamePrompt: 'Subproject name', renamePrompt: 'New project name', movePrompt: 'Enter the new parent project ID; leave empty for root:', deleteConfirm: 'Only empty projects can be deleted. Continue?', created: 'Project created', createFailed: 'Could not create project', renamed: 'Project renamed', renameFailed: 'Could not rename project', moved: 'Project moved', moveFailed: 'Could not move project', deleted: 'Project deleted', deleteFailed: 'Could not delete project', bound: 'Knowledge-base placement updated', bindFailed: 'Could not update placement', loadFailed: 'Could not load project structure' }
  },
  knowledgeBase: {
    title: 'База знаний',

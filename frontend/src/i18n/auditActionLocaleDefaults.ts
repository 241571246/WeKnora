...
const KB_ACTIVITY_ACTION_LABELS_EN: Record<string, string> = {
  ...
  'knowledge.downloaded': 'Knowledge downloaded',
  ...
  'chunk.batch_deleted': 'All document chunks deleted',
  ...
  'kb.member_granted': 'Knowledge-base member granted',
  'kb.member_changed': 'Knowledge-base member changed',
  'kb.member_revoked': 'Knowledge-base member revoked',
  'kb.collection_created': 'Project node created',
  'kb.collection_updated': 'Project node updated',
  'kb.collection_deleted': 'Project node deleted',
  'kb.collection_bound': 'Knowledge-base placement changed',
  'rbac.access_denied': 'Knowledge-base access denied',
